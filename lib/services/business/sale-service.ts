...
export class SaleService {
  ...
  //         // 🟢 FIX 1: Generate a FRESH, unique sequence customId for EVERY item line log inside the loop
  ...
  //           data: {
  //             customId: currentStockLogId, // Use the dynamically generated unique ID
  //             productVariantId: item.productVariantId,
  //             action: "UPDATE",
  //             logType: "Check Out",
  ...
  //     if (validatedData.paymentMethod === "CASH" || validatedData.paymentMethod === "SPLIT") {
  //       // 🟢 FIX 2: Generate unique custom ID specifically for the CASH portion
  ...
  //       // 🟢 FIX 3: Generate unique custom ID specifically for the MOMO portion
  ...
  //           businessId,
  //           shopId,
  //           dueDate: today, // POS checkout sets terms to immediate payment
  //           saleId: sale.id,
  //         }
  //       });

  //       // ── STEP E: Auditing Trail ─────────────────
  ...
  //           businessId: businessId,
  //           oldValue: "None",
  //           details: `New sale ${validatedData.paymentMethod} created`
  //         }
  //       });
  ...
  //     // 4. STEP F: Post-Transaction Paystack Processing
