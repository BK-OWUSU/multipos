...
export function LoginForm({ className, ...props }: React.ComponentProps<"form">) {
  ...
  return (
    <FormProvider {...forms}>
      <form onSubmit={handleSubmit(onSubmit)} className={cn("flex flex-col gap-4 bg-red", className)} {...props}>
        <FieldGroup className="space-y-3.5">
          ...
          <Field className="pt-1">
            <motion.div whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }}>
              <CustomButton 
                ...
                className="w-full h-11 bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 font-bold text-sm rounded-xl shadow-lg shadow-blue-600/25 transition-all duration-200"
          ...
          <div className="relative flex py-1 items-center">
            ...
            <span className="shrink mx-3 text-slate-400 text-[10px] font-bold uppercase tracking-wider">or continue with</span>
            <div className="grow border-t border-slate-200"></div>
          </div>
  ...
  return (
    <div className="min-h-screen w-full bg-[#030712] flex items-center justify-center p-0 lg:p-4 font-sans relative overflow-hidden">
      ...
      <motion.div 
        ...
        className="w-full max-w-350 bg-white/95 backdrop-blur-2xl lg:rounded-[2rem] shadow-2xl shadow-blue-950/20 border border-white/20 overflow-hidden grid grid-cols-1 lg:grid-cols-12 min-h-190 relative z-10 my-auto"
      >
        ...
        <div className="lg:col-span-5 p-6 sm:p-8 lg:p-10 flex flex-col justify-between bg-white relative">
          ...
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center gap-2.5 font-bold group">
              <div className="flex size-9 items-center justify-center rounded-xl bg-linear-to-br from-blue-600 to-indigo-600 text-white shadow-md shadow-blue-600/30 group-hover:scale-105 transition-transform">
          ...
          <div className="w-full max-w-97.5 mx-auto my-auto space-y-5 py-3">
        ...
        <div className="lg:col-span-7 bg-linear-to-br from-[#0b1329] via-[#111c38] to-[#070b16] p-6 lg:p-10 flex flex-col justify-between relative overflow-hidden text-white border-l border-slate-800/50">
          ...
          <div className="relative w-full max-w-140 mx-auto my-auto py-4 scale-[0.95] origin-center">
